  ...
  async ({ page = 1, limit = 50 } = {}, { rejectWithValue, getState }) => {
    try {
      ...
      if (!auth.isAuthenticated) {
        return { posts: [], total: 0, lastFetched: null };
      }
      ...
      console.error("[fetchFollowingPosts] Error:", errMsg, error);
...
export const fetchPublicPosts = createAsyncThunk(
  ...
  async ({ tag = null, after = null }, { rejectWithValue }) => {
    try {
      ...
      console.error("[fetchPublicPosts] Error:", errMsg, error);
      return rejectWithValue({ message: errMsg });
    }
  }
);
...
export const createPosts = createAsyncThunk(
  ...
  async (postData, { rejectWithValue, getState }) => {
    ...
    try {
      ...
      console.error("[createPosts] Error:", errMsg, error);
      return rejectWithValue({ message: errMsg });
    }
  }
);
...
export const getAllPosts = createAsyncThunk(
  ...
  async (
    ...
    try {
      const { auth } = getState();
      if (!auth.isAuthenticated) {
        return { posts: [], total: 0, lastFetched: null, isMyPosts: !!userId };
      }
      const params = new URLSearchParams();
      params.append("page", page);
      params.append("limit", limit);
      ...
      console.error("[getAllPosts] Error:", errMsg, error);
      return rejectWithValue({ message: errMsg });
    }
  }
);
...
export const getLatestPosts = createAsyncThunk(
  ...
  async ({ after = null } = {}, { rejectWithValue }) => {
    try {
      ...
      console.error("[getLatestPosts] Error:", errMsg, error);
      return rejectWithValue({ message: errMsg });
    }
  }
);
...
export const getTrendingPosts = createAsyncThunk(
  ...
  async ({ after = null } = {}, { rejectWithValue }) => {
    try {
      ...
      console.error("[getTrendingPosts] Error:", errMsg, error);
      return rejectWithValue({ message: errMsg });
    }
  }
);
...
export const getSearchPosts = createAsyncThunk(
  ...
  async ({ query, userId, after = null }, { rejectWithValue }) => {
    try {
      ...
      console.error("[getSearchPosts] Error:", errMsg, error);
      return rejectWithValue({ message: errMsg });
    }
  }
);
...
export const getSinglePost = createAsyncThunk(
  ...
  async ({ slug, isGuest = false }, { rejectWithValue }) => {
    try {
      ...
      console.error("[getSinglePost] Error:", errMsg, error);
      return rejectWithValue({ message: errMsg });
    }
  }
);
...
export const updatePost = createAsyncThunk(
  ...
  async ({ slug, updateData }, { rejectWithValue }) => {
    try {
      ...
      console.error("[updatePost] Error:", errMsg, error);
      return rejectWithValue({ message: errMsg });
    }
  }
);
...
export const deletePost = createAsyncThunk(
  ...
  async (postId, { rejectWithValue }) => {
    try {
      ...
      console.error("[deletePost] Error:", errMsg, error);
      return rejectWithValue({ message: errMsg });
    }
  }
);
...
export const fetchUserPosts = createAsyncThunk(
  ...
  async ({ userId, after = null, search, sort }, { rejectWithValue }) => {
    try {
      ...
      console.error("[fetchUserPosts] Error:", errMsg, error);
      return rejectWithValue({ message: errMsg });
    }
  }
);
...
export const submitReadingTime = createAsyncThunk(
  ...
  async ({ postId, timeSpent }, { rejectWithValue }) => {
    try {
      ...
      console.error("[submitReadingTime] Error:", errMsg, error);
      return rejectWithValue({ message: errMsg });
    }
  }
);
...
export const sendAdminAppeal = createAsyncThunk(
  ...
  async ({ postId, message }, { rejectWithValue }) => {
    try {
      ...
      console.error("[sendAdminAppeal] Error:", errMsg, error);
      return rejectWithValue({ message: errMsg });
    }
  }
);
