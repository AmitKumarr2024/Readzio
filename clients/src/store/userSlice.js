...
export const getUser = createAsyncThunk(
  ...
  async (_, { rejectWithValue }) => {
    try {
      ...
      console.error("[UserSlice] getUser: Error", {
        message: err.message,
...
export const fetchFollowerLocations = createAsyncThunk(
  ...
  async (
    ...
    try {
      ...
      console.error("[UserSlice] fetchFollowerLocations: Error", {
        message: err.message,
        status: err.response?.status,
        data: err.response?.data,
        stack: err.stack,
...
export const fetchIndiaGeoJson = createAsyncThunk(
  ...
  async (_, { rejectWithValue }) => {
    try {
      ...
      console.error("[UserSlice] fetchIndiaGeoJson: Error", {
        message: err.message,
        status: err.response?.status,
        data: err.response?.data,
        stack: err.stack,
...
export const getAllUsers = createAsyncThunk(
  ...
  async (
    ...
    try {
      ...
      console.error("[UserSlice] getAllUsers: Error", {
        message: err.message,
        status: err.response?.status,
        data: err.response?.data,
        stack: err.stack,
...
export const deleteUser = createAsyncThunk(
  ...
  async (userId, { rejectWithValue }) => {
    try {
      ...
      console.error("[UserSlice] deleteUser: Error", {
        message: err.message,
        status: err.response?.status,
        data: err.response?.data,
        stack: err.stack,
...
export const toggleBlockUser = createAsyncThunk(
  ...
  async (userId, { rejectWithValue, getState }) => {
    try {
      ...
      console.error("[UserSlice] toggleBlockUser: Error", {
        message: err.message,
        status: err.response?.status,
        data: err.response?.data,
        stack: err.stack,
...
export const toggleUserRole = createAsyncThunk(
  ...
  async (userId, { rejectWithValue }) => {
    try {
      ...
      console.error("[UserSlice] toggleUserRole: Error", {
        message: err.message,
        status: err.response?.status,
        data: err.response?.data,
        stack: err.stack,
...
export const getUserById = createAsyncThunk(
  ...
  async (userId, { rejectWithValue }) => {
    try {
      ...
      console.error("[UserSlice] getUserById: Error", {
        message: err.message,
        status: err.response?.status,
        data: err.response?.data,
        stack: err.stack,
...
export const fetchUserActivity = createAsyncThunk(
  ...
  async (userId, { rejectWithValue }) => {
    try {
      ...
      console.error("[UserSlice] fetchUserActivity: Error", {
        message: err.message,
        status: err.response?.status,
        data: err.response?.data,
        stack: err.stack,
...
export const clearUserActivity = createAsyncThunk(
  ...
  async (_, { rejectWithValue }) => {
    try {
      ...
      console.error("[UserSlice] clearUserActivity: Error", {
        message: err.message,
        status: err.response?.status,
        data: err.response?.data,
        stack: err.stack,
...
export const clearOldActivity = createAsyncThunk(
  ...
  async (_, { rejectWithValue }) => {
    try {
      ...
      console.error("[UserSlice] clearOldActivity: Error", {
        message: err.message,
        status: err.response?.status,
        data: err.response?.data,
        stack: err.stack,
...
export const fetchAllUserLocations = createAsyncThunk(
  ...
  async ({ page = 1, limit = 12 }, { rejectWithValue, getState }) => {
    try {
      ...
      console.error("[UserSlice] fetchAllUserLocations: Error", {
        message: err.message,
        status: err.response?.status,
        data: err.response?.data,
        stack: err.stack,
...
export const saveUserLocation = createAsyncThunk(
  ...
  async ({ latitude, longitude, city, country }, { rejectWithValue }) => {
    try {
      ...
      console.error("[UserSlice] saveUserLocation: Error", {
        message: err.message,
        status: err.response?.status,
        data: err.response?.data,
        stack: err.stack,
...
export const searchUsers = createAsyncThunk(
  ...
  async (query, { rejectWithValue }) => {
    try {
      ...
      console.error("[UserSlice] searchUsers: Error", {
        message: err.message,
        status: err.response?.status,
        data: err.response?.data,
        stack: err.stack,
      ...
      return rejectWithValue(
        err.response?.data?.message || err.message || "User search failed"
      );
    }
  }
);
...
export const saveUserConsent = createAsyncThunk(
  ...
  async (consent, { rejectWithValue }) => {
    try {
      ...
      console.error("[UserSlice] saveUserConsent: Error", {
        message: err.message,
        status: err.response?.status,
        data: err.response?.data,
        stack: err.stack,
...
export const getUserIPLocation = createAsyncThunk(
  ...
  async (_, { rejectWithValue }) => {
    try {
      ...
      console.error("[UserSlice] getUserIPLocation: Error", {
        message: err.message,
        status: err.response?.status,
        data: err.response?.data,
        stack: err.stack,
...
export const trackUserIPLocation = createAsyncThunk(
  ...
  async (_, { rejectWithValue }) => {
    try {
      ...
      console.error("[UserSlice] trackUserIPLocation: Error", {
        message: err.message,
        status: err.response?.status,
        data: err.response?.data,
        stack: err.stack,
...
export const shouldShowFeedbackPrompt = createAsyncThunk(
  ...
  async (_, { rejectWithValue }) => {
    try {
      ...
      console.error("[UserSlice] shouldShowFeedbackPrompt: Error", {
        message: err.message,
        status: err.response?.status,
        data: err.response?.data,
        stack: err.stack,
...
export const submitUserFeedback = createAsyncThunk(
  ...
  async ({ rating, message }, { rejectWithValue }) => {
    try {
      ...
      console.error("[UserSlice] submitUserFeedback: Error", {
        message: err.message,
        status: err.response?.status,
        data: err.response?.data,
        stack: err.stack,
...
export const fetchAllUserFeedback = createAsyncThunk(
  ...
  async (_, { rejectWithValue }) => {
    try {
      ...
      console.error("[UserSlice] fetchAllUserFeedback: Error", {
        message: err.message,
        status: err.response?.status,
        data: err.response?.data,
        stack: err.stack,
...
export const sendManualFeedbackPrompt = createAsyncThunk(
  ...
  async ({ userId, message }, { rejectWithValue }) => {
    try {
      ...
      console.error("[UserSlice] sendManualFeedbackPrompt: Error", {
        message: err.message,
        status: err.response?.status,
        data: err.response?.data,
        stack: err.stack,
      ...
      return rejectWithValue(
        err.response?.data?.message ||
          err.message ||
          "Failed to send feedback prompt"
      );
    }
  }
);
...
const userSlice = createSlice({
  ...
  reducers: {
    ...
    setUserId: (state, action) => {
      if (mongoose.Types.ObjectId.isValid(action.payload)) {
    ...
    addUserLocation: (state, action) => {
      ...
      if (mongoose.Types.ObjectId.isValid(location.userId)) {
