   ...
   const AdminDashboard = () => {
     ...
     const tabs = [
       ...
       { id: "data-download", label: "Data Download" },
     ];
           ...
           <ErrorBoundary>
             ...
             {activeTab === "data-download" && (
               <div className="p-6 bg-white dark:bg-gray-800 rounded-xl shadow-sm">
                 <h2 className="text-xl font-semibold mb-4 text-text-main-light dark:text-text-main-dark">
                   Data Download
                 </h2>
                 <p className="mb-4 text-text-main-light dark:text-text-main-dark">
                   Download all data (Users, Posts, Traffic) as an Excel file with separate sheets.
                 </p>
               </div>
             )}
           </ErrorBoundary>
