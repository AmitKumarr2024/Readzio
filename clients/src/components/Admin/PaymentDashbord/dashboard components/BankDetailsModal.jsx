...
const BankDetailsModal = ({ modalUser, fetchedBankDetails, bankLoading, closeModal }) => (
  <div className="fixed inset-0 bg-background-light dark:bg-background-dark text-text-main-light dark:text-text-main-dark flex items-center justify-center z-50 p-4">
    <motion.div
      initial={{ opacity: 0, scale: 0.95 }}
      animate={{ opacity: 1, scale: 1 }}
      exit={{ opacity: 0, scale: 0.95 }}
      className="rounded-2xl p-6 max-w-2xl w-full max-h-[80vh] overflow-y-auto bg-background-light dark:bg-background-dark  border border-gray-100 shadow-2xl backdrop-blur-sm"
    >
