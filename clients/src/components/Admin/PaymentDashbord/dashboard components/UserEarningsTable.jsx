...
const UserEarningsTable = ({
  ...
  <motion.div
    ...
    className="p-4 sm:p-6 rounded-2xl shadow-lg bg-white/90 backdrop-blur-md border border-gray-100"
  >
    <div className="flex flex-col sm:flex-row justify-between items-center mb-6 gap-4">
      ...
      <div className="flex items-center gap-3">
        ...
        <select
          ...
          className="p-2 rounded-lg border border-gray-200 bg-white text-gray-700 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-300 text-sm"
    ...
    <div className="overflow-x-auto rounded-xl border border-gray-100">
      <table className="w-full text-sm text-left table-auto">
        <thead className="bg-blue-50 text-blue-700 font-semibold sticky top-0 z-10">
          <tr>
            <th className="p-3 sm:p-4 w-16" scope="col">Select</th>
            <th className="p-3 sm:p-4 min-w-[200px]" scope="col">User</th>
            <th className="p-3 sm:p-4 w-28" scope="col">Subscription</th>
          ...
          {filteredEarningsArray.length ? (
            filteredEarningsArray.map((earning, index) => (
              <motion.tr
                ...
                className={`border-t border-gray-100 text-gray-800 hover:bg-blue-50/70 transition-all duration-200 ${
              ...
              >
                ...
                <td className="p-3 sm:p-4">
                  {earning.user ? (
                    <div className="flex flex-col">
                      <span className="font-medium text-gray-900">{earning.user.username}</span>
                      <span className="text-xs text-gray-500">{earning.user.email}</span>
                    </div>
                  ) : (
                    "Unknown User"
                  )}
                ...
                <td className="p-3 sm:p-4 flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-3">
                  <button
                    ...
                    className="flex items-center gap-2 px-3 py-1.5 text-sm bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-all duration-300 shadow-sm"
                  ...
                  <button
                    ...
                    className="flex items-center gap-2 px-3 py-1.5 text-sm bg-gray-600 text-white rounded-lg hover:bg-gray-700 transition-all duration-300 shadow-sm"
                  ...
                  <div className="flex items-center space-x-3">
                    {editingAmounts[earning.user._id] ? (
                      <input
                        ...
                        className="w-20 p-1.5 rounded-lg border border-gray-200 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-300 text-sm text-right"
                        placeholder="₹0.00"
                    ...
                    <button
                      ...
                      className="flex items-center gap-1 px-2 py-1 rounded-lg text-xs font-medium bg-blue-100 text-blue-700 hover:bg-blue-200 transition-all duration-300 shadow-sm"
            ...
            <tr>
              <td colSpan="8" className="p-4 sm:p-6 text-center text-blue-500 text-sm">
