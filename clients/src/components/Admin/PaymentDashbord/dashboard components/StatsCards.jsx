  ...
  <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 mb-8">
    {[
      ...
      <motion.div
        ...
        className={`p-4 sm:p-6 rounded-2xl shadow-lg bg-gradient-to-br from-${color}-50 to-${color}-100 hover:shadow-xl transition-all duration-300`}
      >
        <h3 className={`text-sm font-medium text-${color}-600`}>{title}</h3>
        <p className={`text-2xl sm:text-3xl font-bold text-${color}-800`}>
