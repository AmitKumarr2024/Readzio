...
export default function AdminMessageDashboard() {
  ...
  return (
    <div className="min-h-screen bg-background-light dark:bg-background-dark text-text-main-light dark:text-text-main-dark p-4 sm:p-6 md:p-8">
      ...
      {/* Main Grid */}
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-4 md:gap-6 bg-background-light dark:bg-background-dark text-text-main-light dark:text-text-main-dark">
        {/* User Panel */}
        <div className="lg:col-span-2">
          <div className="bg-background-light dark:bg-background-dark  rounded-2xl shadow-lg border border-gray-100 p-5 h-[calc(100vh-250px)] sm:h-[500px] overflow-y-auto transition-all duration-300">
            <UserMessagePanel
        ...
        <div className="lg:col-span-3">
          <div className="bg-background-light dark:bg-background-dark rounded-2xl shadow-lg border border-gray-100 p-5 h-[calc(100vh-250px)] sm:h-[500px] overflow-y-auto">
      ...
      {/* Notification Form */}
      <div className="mt-6 bg-background-light dark:bg-background-dark rounded-2xl shadow-lg border border-gray-100 p-6">
