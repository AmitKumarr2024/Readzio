    ...
    <>
      ...
      <div className="hidden md:block">
        <motion.div
          ...
          className="fixed left-0 top-20 h-[850px] bg-gradient-to-b from-gray-900 via-gray-800 to-gray-900 shadow-2xl z-50 flex flex-col border-r border-gray-700 gpu-accelerated"
        >
          {/* Toggle Button */}
          <motion.button
