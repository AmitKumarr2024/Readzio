...
const CardOfPost = ({
  ...
  return (
    <div className="group relative bg-white dark:bg-slate-900 rounded-2xl shadow-lg transition-all duration-500 hover:shadow-[0_20px_50px_rgba(59,130,246,0.15)] dark:hover:shadow-[0_20px_50px_rgba(0,0,0,0.4)] overflow-hidden border border-gray-100 dark:border-slate-800 hover:border-blue-200 dark:hover:border-slate-700 transform hover:-translate-y-1 h-full flex flex-col">
