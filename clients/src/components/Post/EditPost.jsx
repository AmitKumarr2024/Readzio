  ...
  return (
    <>
      <LoadingBar
        ...
        text={updateLoading ? "Saving Changes..." : ""}
        className="z-[10001]"
      />
      <ErrorBoundary>
        <Transition show={isOpen} as={React.Fragment}>
          <div className="fixed inset-0 z-[9999] flex items-start justify-center overflow-hidden bg-black/60 backdrop-blur-sm">
            <Transition.Child
              as={React.Fragment}
            ...
            >
              <div className="relative w-full h-full overflow-y-auto bg-gradient-to-br from-gray-50 via-white to-gray-100 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
                {/* Fixed Header */}
                <div className="fixed w-full -top-2 z-[10000] bg-white/80 dark:bg-gray-800/80 backdrop-blur-lg border-b border-gray-200 dark:border-gray-700 shadow-sm">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="sticky bottom-0 left-0 right-0 bg-gradient-to-t from-white via-white to-transparent dark:from-gray-900 dark:via-gray-900 pt-6 pb-1 sm:pb-2">
                      ...
                      >
                        {updateLoading ? (
                          <>
                            <div className="animate-spin z-[10000] rounded-full h-5 w-5 border-b-2 border-white"></div>
                            Saving Changes...
                          </>
                        ) : (
                          <>
