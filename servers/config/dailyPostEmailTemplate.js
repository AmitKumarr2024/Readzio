...
<body>
  <div class="email-wrapper">
        <table role="presentation" cellpadding="0" cellspacing="0" width="100%" style="margin-bottom: 20px;">
          <tr>
            <td align="center">
              <table role="presentation" cellpadding="0" cellspacing="0" style="display: inline-flex; align-items: center;">
                <tr>
      ...
      <div class="post">
        ...
        <div class="post-content">
         ...
         <table cellpadding="0" cellspacing="0" role="presentation" width="100%" style="margin: 16px 0; height: 60px;">
            <tr>
               <td style="font-size: 65px; font-weight: bold; color: #374151; padding-right: 20px;">
                📖
              </td>
              <td width="16.6%" align="left" valign="middle" style="font-size: 15px; font-weight: bold; line-height: 24px; color: #6b7280;">
               ...
               <td style="font-size: 65px; font-weight: bold; color: #6b7280; padding-right: 20px;">
                ❤️
              </td>
              <td width="16.6%" align="left" valign="middle" style="font-size: 15px; font-weight: bold; line-height: 24px; color: #6b7280;">
