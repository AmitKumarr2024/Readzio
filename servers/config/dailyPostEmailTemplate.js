        ...
        <div class="post-content">
          <a href="https://inksha.onrender.com/post/{{this.slug}}" class="post-title">{{this.title}}</a>
            ...
            <table cellpadding="0" cellspacing="0" role="presentation" width="100%" style="margin: 12px 0;">
              <tr>
                <td width="16.6%" align="center" valign="middle" style="font-size: 18px; line-height: 1.2; font-weight: normal; color: #374151;">
                  📖
                </td>
                <td width="16.6%" align="left" valign="middle" style="font-size: 17px; font-weight: bold; color: #374151;">
