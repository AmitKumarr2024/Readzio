          ...
          <table class="wrapper" width="700" cellpadding="0" cellspacing="0" role="presentation" style="width:100%; max-width:700px; margin:30px auto; background-color:#ffffff; border-radius:12px; border:1px solid #e5e7eb; box-shadow:0 6px 20px rgba(0,0,0,0.05);">
                ...
                <table cellpadding="0" cellspacing="0" role="presentation">
                  <tr>
                    <td style="padding-right:10px;">
                      <img src="https://inksha.onrender.com/public/logo1.png" alt="Inksha Logo" width="40" height="40" style="border-radius:50%; display:block;">
                    </td>
                ...
                <table width="100%" cellpadding="0" cellspacing="0" role="presentation" style="border:1px solid #e5e7eb; border-radius:10px; overflow:hidden;">
                  ...
                  <tr>
                    <td style="padding:20px;">
                      <a href="https://inksha.onrender.com/post/{{this.slug}}" style="display:block; font-size:20px; font-weight:700; color:#1d4ed8; text-decoration:none; margin-bottom:10px;">{{this.title}}</a>
                      ...
                      <!-- Read More -->
                      <a href="https://inksha.onrender.com/post/{{this.slug}}" style="display:inline-block; font-size:14px; font-weight:600; color:#10b981; border:1px solid #10b981; padding:8px 16px; border-radius:6px; text-decoration:none;">Read More</a>
                    </td>
                  </tr>
                </table>
              </td>
            ...
            <tr>
              <td style="padding:30px; font-size:14px; color:#6b7280;">
                No new posts today — check out more at <a href="https://inksha.onrender.com" style="color:#2563eb; font-weight:600; text-decoration:none;">Inksha</a>.
              </td>
            </tr>
            {{/unless}}
