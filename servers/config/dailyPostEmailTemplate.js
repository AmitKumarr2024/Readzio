    ...
    <div class="content">
      ...
      <div class="post">
        ...
        <div class="post-content">
         ...
         <table cellpadding="0" cellspacing="0" role="presentation" width="100%" style="margin: 8px 0; height: 60px;">
            <tr>
               <td style="font-size: 14px; font-weight: bold; color: #6b7280; padding-right: 3px;">
                Read
              </td>
              <td width="16.6%" align="left" valign="middle" style="font-size: 10px; font-weight: bold; line-height: 24px; color: #6b7280;">
